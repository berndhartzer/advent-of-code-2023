...
func TestSolutions(t *testing.T) {
	...
	t.Run("day 5", func(t *testing.T) {
		runner := func(t *testing.T, tests map[string]dayFiveTestConfig, fn func([]string) int) {
			for name, cfg := range tests {
				cfg := cfg
				t.Run(name, func(t *testing.T) {
					start := time.Now()
		...
		partOne, partTwo, err := getDayFiveTests()
		if err != nil {
			t.Errorf("failed to get tests: %v", err)
		}

		t.Run("part 1", func(t *testing.T) {
			runner(t, partOne, dayFivePartOne)
		})

		t.Run("part 2", func(t *testing.T) {
			runner(t, partTwo, dayFivePartTwo)
		})
	})
	...
	t.Run("day 7", func(t *testing.T) {
		runner := func(t *testing.T, tests map[string]daySevenTestConfig, fn func([]string) int) {
			for name, cfg := range tests {
				cfg := cfg
				t.Run(name, func(t *testing.T) {
					start := time.Now()
		...
		partOne, partTwo, err := getDaySevenTests()
		if err != nil {
			t.Errorf("failed to get tests: %v", err)
		}

		t.Run("part 1", func(t *testing.T) {
			runner(t, partOne, daySevenPartOne)
		})

		t.Run("part 2", func(t *testing.T) {
			runner(t, partTwo, daySevenPartTwo)
		})
	})

	t.Run("day 8", func(t *testing.T) {
		runner := func(t *testing.T, tests map[string]dayEightTestConfig, fn func([]string) int) {
			for name, cfg := range tests {
				cfg := cfg
				t.Run(name, func(t *testing.T) {
					start := time.Now()
		...
		partOne, partTwo, err := getDayEightTests()
		if err != nil {
			t.Errorf("failed to get tests: %v", err)
		}

		t.Run("part 1", func(t *testing.T) {
			runner(t, partOne, dayEightPartOne)
		})

		t.Run("part 2", func(t *testing.T) {
			runner(t, partTwo, dayEightPartTwo)
		})
	})

	t.Run("day 9", func(t *testing.T) {
		runner := func(t *testing.T, tests map[string]dayNineTestConfig, fn func([]string) int) {
			for name, cfg := range tests {
				cfg := cfg
				t.Run(name, func(t *testing.T) {
					start := time.Now()
		...
		partOne, partTwo, err := getDayNineTests()
		if err != nil {
			t.Errorf("failed to get tests: %v", err)
		}

		t.Run("part 1", func(t *testing.T) {
			runner(t, partOne, dayNinePartOne)
		})

		t.Run("part 2", func(t *testing.T) {
			runner(t, partTwo, dayNinePartTwo)
		})
	})
}
